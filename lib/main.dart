...
//   }
// }
// class HomeContent extends StatelessWidget {//图片演示
//   @override
//   Widget build(BuildContext context) {
...
//           child: Column(
//         children: [
//           Text('按钮测试', style: TextStyle(fontSize: 20)),
//           ElevatedButton(
//             onPressed: () {},
//             child: Text('普通按钮'),
//           ),
...
//             child: Column(
//           children: [
//             Text('表单测试', style: TextStyle(fontSize: 20)),
//             TextFormField(
//               autofocus: true,
...
class HomeContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
        child: Column(
      children: [
        Text('进度条演示', style: TextStyle(fontSize: 20)),
